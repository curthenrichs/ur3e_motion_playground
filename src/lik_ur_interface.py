...
class LikUrInterfaceNode:
    ...
    def __init__(self, info_file_path, gripper_joint, joint_step_delay, start_enabled):
    ...
    def _ja_cb(self, ja, enableOverride=False):
        if self._enabled or enableOverride:
            ...
            if self._grip_idx != None:
                pass
                #grip = ja.angles.data[self._grip_idx]
                #self._grip_cmd(grip)

            point = JointTrajectoryPoint()
            angles = list(ja.angles.data)
            if self._grip_idx != None:
                angles.pop(self._grip_idx)
    ...
    def _arm_move(self, p):
        ...
        if self._grip_idx != None:
            print len(names), self._grip_idx
            names.pop(self._grip_idx)
...
if __name__ == "__main__":
    ...
    node = LikUrInterfaceNode(info_file_path, gripper_joint, joint_step_delay, start_enabled)
    rospy.spin()
